...
class PretrainedModel:
    ...
    def get_path_to_checkpoint(self, checkpoint: int) -> str:
        ...
        # Can directly change this path to target checkpoint. 
...
@pretrained_model()
class SyntheticRLV2_big(PretrainedModel):
    def __init__(self):
        super().__init__(
            model_name="synthetic-rl-v2-big",
            model_gin_config="synthetic_multitaskagent_big.gin",
            train_gin_config="binary_rl.gin",
...
@pretrained_model()
class SyntheticRLV2_g9(PretrainedModel):
    def __init__(self):
        super().__init__(
            model_name="synthetic-rl-v2",
            model_gin_config="synthetic_multitaskagent.gin",
            train_gin_config="binary_rl.gin",
            default_checkpoint=28,
            action_space=get_action_space("DefaultActionSpace"),
            observation_space=get_observation_space("TeamPreviewObservationSpace"),
            tokenizer=get_tokenizer("DefaultObservationSpace-v1"),
            gin_overrides={
